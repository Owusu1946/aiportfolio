...
export function Presentation() {
  ...
  const profile = {
    ...
    description:
      "Hey 👋\nI'm Kenneth Owusu. I'm a developer specializing in AI and Fullstack Development. I'm working at Codin AI in Ghana. I'm passionate about AI, tech, Entrepreneurship and SaaS tech.",
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['AI', 'Developer', 'Optimedix', 'Fullstack', 'SaaS Builder'].map(
              (tag) => (
                <span
                  key={tag}
