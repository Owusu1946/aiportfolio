    ...
    >
      ...
      <div className="mt-10">
        ...
        <p className="text-foreground text-sm">
          Real-world AI dev experience from Oma at optimedix (MCP, secure GPTs, RAG
          pipelines). <br /> 3x hackathon wins (Hackit GH, HackaMe Challenge,
          Colosseum Breakout on Solana). <br /> I ship fast, and love
